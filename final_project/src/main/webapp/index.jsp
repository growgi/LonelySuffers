							...
							<div class="item-top form-inline">
								<div class="form-group">
									<div class="input-group2">
										...
										</span> <input type="url" class="form-control" id="urladres" name="url" placeholder="제출 폼">
									</div>
								</div>
								<input type="submit" name="send" value="제출" class="btn btn-default" />
							</div>
						</div>
					</form>
				</div>
						...
						<table class="table">
							...
							<tbody>
								...
								<tr class="row">
									...
									<td class="col-md-8">Perfect! The "Canonical" tags on your
										site are mukvut and url is structured correctly</td>
								</tr>
								<tr class="row">
								...
								<tr class="row">
									...
									<td class="col-md-8">Good! There is (1) H1 tag on your web
										site.
										<ul>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="feature-widget">
						<h3>위쪽에서 날아오며 등장</h3>
						<p>
							Morbi quis porta dolor. Nullam feugiat sapien et libero elementum
							faucibus. Praesent sagittis venenatis ipsum, eget tristique odio
							pharetra quis. Sed maximus a eros quis ornare. Proin tempor dolor
							a auctor convallis. The screen from <a
				...
				<div class="col-md-6">
					<div class="feature-widget">
						...
						<p>
							...
							faucibus. Praesent sagittis venenatis ipsum, eget tristique odio
							pharetra quis. Sed maximus a eros quis ornare. Proin tempor dolor
							a auctor convallis. Check the awesome tool <a
	...
	<section class="section bt">
		<div class="container">
			<div class="section-title text-center">
				...
				<h3>캐러셀(Carousel)</h3>
				<p>
					자동 슬라이드는 따로 스크립트 더 넣어줘야 가능<br>사진 위에 마우스 호버 시 효과 있음
				</p>
			</div>
			<!-- end section-title -->
	...
	<section class="section bt">
		<div class="container">
			<div class="section-title text-center">
				...
				<hr>
				<p class="lead">SeoTime is recognized as a Top Search Engine
					Optimization Agency by;</p>
			</div>
			<!-- end section-title -->
							...
							<div class="panel panel-default">
								...
								<div id="collapseOne" class="panel-collapse collapse in">
									<div class="panel-body">
										<p>All major search engines such as Google, Bing and Yahoo
											have primary search results, where web pages and other
											content such as videos or local listings are shown and ranked
											based on what the search engine considers most relevant to
											users. Payment isn’t involved, as it is with paid search ads.</p>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
