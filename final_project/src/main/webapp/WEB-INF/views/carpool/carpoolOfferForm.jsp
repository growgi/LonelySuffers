...
<!-- class가 row인 div 안에 구현하시면 됩니다. -->
        ...
        <tbody> 
            ...
            <tr> 
                <td>
		    <input type="text" id="details" name="departureDistrict" placeholder="0/20" style="text-align: right; width:100%;">
                </td>
            </tr>
        </tbody> 
        <tbody> 
            ...
            <tr> 
                <td>
		    <input type="text" id="details" name="arrivalDistrict" placeholder="0/20" style="text-align: right; width: 100%;">
                </td>
            </tr>
        </tbody> 
    </table>
                ...
                <tbody> 
                    <tr> 
                        ...
                        <td>
                            <!--달력 api-->
                            <input type="date" id="start" name="trip-start"
                               value="2023-05-03" min="2023-05-03" max="2023-12-31">
                        </td>
                        <td>
                            <!--오전 오후 중에 체크하는 radio-->
                            <input type="radio" id="am" name="departureTime" value="0">
                    ...
                    <tr>
                        <th style="width:35%; text-align:center;">인원</th>
                        <td>
                            <select class="form-control" name="capacity" id="capacity">
                                <option value="" selected disabled>탑승인원</option>
                                <option value="1">1명</option>
                    ...
                    <tr>
                        <th style="width:35%; text-align:center;">금액</th>
                        <td>
                            <input type="text" id="carpoolPrice" name="carpoolPrice" placeholder="원" style="text-align: right;">
                        </td>
                    </tr>
                    <tr>
                        <th style="width:35%; text-align:center;">상세</th>
                        <td rowspan="4"><input type="text" id="driverMsg" name="driverMsg" placeholder="0/60" style="text-align: right;"></td>
                    </tr>
                </table>
        </div>
