...
<body>
	<div id="wrapper">
		...
		<section class="section"
			...
			<div class="container"
				style="width: 850px; margin-top: 20px; padding: 20px;">
				<div class="row"
					style="border: 1px solid #FFB4B4; border-radius: 20px; padding: 20px; background-color: #FFF3E2;">
					<form action="/registerCarpool.do" onsubmit="return checkReturn();"
						...
						<table style="border: 1px solid #fff; width: 500px;">
							<tbody>
								...
								<tr>
									<th rowspan="2"
										style="width: 30%; text-align: center; border: 1px solid #FFF3E2; height: 80px;">출발</th>
									<td style="border: 1px solid #FFF3E2"><select
										class="form-control" name="departureRegion" id="city"
										style="width: 70%; border-radius: 10px; border: 1px solid pink;">
								...
								<tr>
									<td><input type="hidden" id="driverNo" name="driverNo"
										value="${sessionScope.m.memberNo }"> <input
										type="hidden" name="onewayRound" value="1"> <input
										type="text" id="details" name="departureDistrict"
										placeholder="0/20"
										style="text-align: right; width: 100%; height: 35px; border-radius: 10px; border: 1px solid pink;"
										required></td>
								</tr>
							</tbody>
							<tbody>
								<tr>
									...
									<td style="border: 1px solid #FFF3E2"><select
										class="form-control" name="arrivalRegion" id="city"
										style="width: 70%; border-radius: 10px; border: 1px solid pink;">
											<option value="" selected disabled>시/도</option>
											<option value="서울">서울</option>
											<option value="경기">경기</option>
								...
								<tr>
									<td><input type="text" id="details" name="arrivalDistrict"
										placeholder="0/20"
										style="text-align: right; width: 100%; height: 35px; border-radius: 10px; border: 1px solid pink;"
										required></td>
								</tr>
						...
						<div class="tab-wrap" style="width: 800px; margin: 10px auto;">
							<ul class="tabs"
								style="margin: 0; padding: 0; list-style-type: none; overflow: hidden; cursor: pointer;">
								<li class="trip oneway"
									style="float: left; width: 50%; height: 50px; text-align: center; line-height: 50px; background-color: #F9E2AF;">편도</li>
								<li class="trip round"
									style="float: left; width: 50%; height: 50px; text-align: center; line-height: 50px; background-color: #ad8b73; color: #fffbe9;">왕복</li>
							</ul>
							<br>
							<br>
						</div>
								...
								<table>
									<tbody>
											...
											<td>
												<div>
													...
													<input type="text" id="departureDate" name="departureDate"
														style="border: 1px solid pink; height: 40px; border-radius: 10px;"
														required>
										...
										<tr>
											...
											<td><select class="form-control" name="capacity"
												id="capacity"
												style="height: 40px; border: 1px solid pink; border-radius: 10px;">
													<option selected disabled>탑승인원</option>
											...
											<td
												style="border-radius: 20px; background-color: pink; color: white;">
												<label for="surfboardRoom" onclick="toggleStorage()"
												style="cursor: pointer; width: 100%; text-align: center; height: 23px; line-height: 25px;">보드
													수납가능 <img src="/resources/images/carpool/checked.png"
													alt="img" style="width: 30px; height: 30px;">
											</label> <input type="checkbox" id="surfboardRoom"
												name="surfboardRoom" value="1" style="display: none;">
											</td>
										</tr>
										<tr>
											<th style="text-align: center; height: 50px;">금액</th>
											<td><input type="number" id="carpoolPrice"
												name="carpoolPrice" placeholder="원"
												style="text-align: right; height: 40px; border: 1px solid pink; border-radius: 10px;">
											</td>
										</tr>
										<tr>
											<th style="text-align: center; height: 50px;">상세</th>
											<td rowspan="4" colspan="8"><input type="text"
												id="driverMsg" name="driverMsg" placeholder="0/60"
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>
											...
											이용이 제한할 수 있으며 경찰 등 수사시관에 적극 협조하고 있습니다.
										</p>
									</div>
						...
						<div class="button-wrap"
							...
							<button type="submit" onclick="return checkValue();"
								class="btn btn-primary"
								style="width: 150px; height: 50px; text-align: center;">등록</button>
						</div>
					</form>
