...
<script src="resources/js/carpoolMain.js"></script>
</head>
...
<!-- class를 section 이 아니라 section nopad 로 하시면, 좌우 여백 없이 화면 너비 크기 전체에다가 section의 background-color를 부여할 수 있습니다. -->
		<section class="section transheader homepage parallax" style="background-image: url('resources/images/carpool/surftruck2.png'); opacity:0.7">
...
<!-- class가 row인 div 안에 구현하시면 됩니다. -->
					...
					<div class="col-md-7">
						<div class="journey">
							<img src="resources/images/carpool/destination.png" style="height: 50px; width: 45px; margin-left: 50px; float: left;">
